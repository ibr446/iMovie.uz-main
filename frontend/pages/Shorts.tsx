...
const fallbackShorts: ShortItem[] = [
  {
    ...
    views: 118000,
    videoUrl: 'Movie.mp4',
    caption: "“True Education” is a Korean drama about a special education inspection team that steps into troubled schools where discipline has broken down and teachers are disrespected. The main character and his team use strict but effective methods to restore order and justice within the education system.",
    audio: 'Orginal Sound',
    location: 'South Korea',
    tags: ['Action', 'Drama', 'School life'],
  },
  {
    id: 'short-2',
    ...
    caption: "Bloodhounds is a South Korean action-crime drama about two young boxers who get caught in a dangerous world of debt and loan sharks. They team up with a kind moneylender to fight against a ruthless criminal organization that exploits desperate people.",
    audio: 'Original Sound',
    location: 'South Korea',
    tags: ['acion', 'crime', 'thriller', 'drama'],
  },
  {
    id: 'short-3',
    ...
    views: 276000,
    videoUrl: 'videoplayback.mp4',
    caption: "“Agent Kim” is a story about a secret intelligence agent who carries out dangerous missions. After a critical incident, he becomes a target himself. Now he must uncover the truth while fighting to survive against powerful enemies. The film blends action, drama, and thriller elements.",
